...
void Application::createLogicalDevice() {
    ...
    std::set<uint32_t> uniqueQueueFamilies = {indices.graphicsFamily.value(), indices.presentFamily.has_value()};
...
void Application::createSwapchain() {
    ...
    createInfo.compositeAlpha = VK_COMPOSITE_ALPHA_OPAQUE_BIT_KHR; // TODO: experiment with other values
...
void Application::createGraphicsPipeline() {
    auto vertShaderCode = readFile("res/bin/shader.vertex.spv");
    auto fragShaderCode = readFile("res/bin/shader.fragment.spv");
